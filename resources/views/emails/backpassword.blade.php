...
<table background="http://picturepath" width="675px" height="570px" style="font-size:14px;margin:0 auto;">
    ...
    <tr><td style="padding:0px 64px;font-size:14px"> 请点击下面的链接验证您的帐号，进行重置密码<br><a href="{{ URL('api/auth/back/email?token='.$data['token'])}}" target="_blank" style="cursor:pointer;text-decoration:none;color:#0082cb">{{ URL('api/auth/back/email?token='.$data['token']) }}</a><br>（如果点击链接没反应，请复制激活链接，粘贴到浏览器地址栏后访问）</td></tr>
    <tr><td style="padding:30px 64px 10px;color:#959393;font-size:14px">此链接2小时内有效。<br>验证链接将在您激活一次后失效。</td></tr>
